  ...
  <section id="pricing" className="pricing-section">
    <div className="pricing-container">
      <div className="pricing-header">
        ...
        <p className="pricing-subtitle">Select your entry point to a digital empire. All prices include 18% GST.</p>
      </div>
      ...
      <div className="pricing-grid">
        ...
        <div className="price-card starter-card">
          <div className="card-top">
            ...
            <div className="price-box">
              ...
              <span className="amount">35,400</span>
            </div>
            <p className="setup-fee">₹30,684 Setup Fee (incl. GST)</p>
            <p className="monthly-fee">+ ₹4,716.46 Monthly (incl. GST)</p>
          </div>
          ...
          <button className="btn-outline" onClick={() => handlePayment('Starter', 35400)}>
            Get Started
          </button>
        </div>
        ...
        <div className="price-card silver-card featured">
          ...
          <div className="card-top">
            ...
            <div className="price-box">
              <span className="currency">₹</span>
              <span className="amount">73,132</span>
              <span className="old-price">₹87,281</span>
            </div>
            <p className="setup-fee">₹30,684 Setup Fee (incl. GST)</p>
            <p className="monthly-fee">
              ₹3,537.35/mo billed yearly <span className="save-badge">Save 25%</span>
            </p>
          </div>
          <ul className="feature-list">
          ...
          <button className="btn-white" onClick={() => handlePayment('Silver', 73132)}>
            Select Silver
          </button>
        </div>
        ...
        <div className="price-card gold-card">
          <div className="card-top">
            ...
            <div className="price-box">
              <span className="currency">₹</span>
              <span className="amount">1,32,559</span>
            </div>
            <p className="setup-fee">₹30,684 Setup Fee (incl. GST)</p>
            <p className="monthly-fee">
              ₹2,829.88/mo billed for 3 years <span className="save-badge-green">Save 40%</span>
            </p>
          </div>
          <ul className="feature-list">
          ...
          <button className="btn-blue" onClick={() => handlePayment('Gold', 132559)}>
            Go Pro Gold
          </button>
        </div>
      </div>
